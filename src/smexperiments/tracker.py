...
class Tracker(object):
    ...
    def create(
        cls,
        trial_component_name="TrialComponent",
        display_name=None,
        artifact_bucket=None,
        artifact_prefix=None,
        boto3_session=None,
        ...
        Args:
            trial_component_name: (str,optional). The name of the trial component resource. Defaults to "TrialComponent".
        ...
        tc = trial_component.TrialComponent.create(
            trial_component_name=_utils.name(trial_component_name),
